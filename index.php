...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <div class="row">
        <div class="col-xl-6">
          <h1>مرحباُ بكم في بيئتنا للتعلم التكيفي </h1>
          <br>
          <h2>و سنقوم برحلة لتنمية بعض مهارات البرمجة بمجال تكنولوجيا المعلومات والاتصالات لطالبات المرحلة الثانوية</h2>
          <a href="sign-up.html" style="color: white;" class="btn-get-started scrollto">انشاء حساب جديد</a>
          <a href="login.html" style="color: white;" class="btn-get-started scrollto">تسجيل الدخول</a>
        </div>
      </div>
    </div>
