    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up" style="padding-top: 100px;">
        ...
        <div class="section-title">
          <h2>تواصل معنا</h2>
          <p>املا استماره الاستفسار التاليه فى حالة واجهتك اى مشكله و سنتواصل معك سريعا</p>
        </div>
          ...
          <div class="col-lg-6">
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="form-group">
                <input type="text" class="form-control" name="subject" id="subject" placeholder="عنوان الرساله" required>
              </div>
              <div class="form-group">
