    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up" style="padding-top: 100px;">
        ...
        <div class="section-title">
          <h2>تسجيل دخول</h2>
          <p>من فضلك ادخل بريدك الالكترونى و الرقم السرى للدخول الى صفحة التعلم الخاصه بك</p>
        </div>

        <div class="row" data-aos="fade-up" data-aos-delay="100">

          <div class="col-lg-12 formy">
            <form action="Login_Inc.php" method="post" role="form">
              <div class="row">
              ...
              <div class="text-center"><button class="get-started-btn" type="submit" name="submit">دخول</button></div>
            </form>
          </div>
