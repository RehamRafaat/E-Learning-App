    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up" style="padding-top: 100px;">
        ...
        <div class="section-title">
          ...
          <p>تاكد من ادخال بياناتك صحيحه لتحصل على افضل خدمه ممكنه</p>
        </div>

        <div class="row" data-aos="fade-up" data-aos-delay="100">

          <div class="col-lg-12 formy">
            <form action="Signup.Inc.php" method="post" role="form">
               <div class="form-group">
                  <input type="text" class="form-control" name="nickname" id="name" placeholder="اللقب" required>
                </div>
                <div class="form-group">
              ...
              <div class="form-group">
                <input type="text" class="form-control" name="password" id="subject" placeholder="الرقم السرى" required>
              </div>
              <div class="text-center"><button class="get-started-btn" type="submit" name="next">تسجيل</button></div>
            </form>
          </div>
