      ...
      <div class="container" data-aos="fade-up" style="padding-top: 100px;">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-12 formy">
            <form action="test_sol.php" method="post" role="form">
               <div class="form-group">
                 <h5>هل لديك معرفة  بلغات البرمجة ؟</h5>
                  <label>نعم</label>
                ...
                <div class="form-group">
                 <h5>هل درستي اى لغة البرمجة فى الاعوام الدراسية السابقة؟</h5>
                  <label>نعم</label>
                ...
                <div class="form-group">
                 <h5>الديك معرفة بالمبادىء والقواعد الاساسية فى البرمجة؟</h5>
                  <label>نعم</label>
              ...
              <div class="form-group">
               <h5>هل سبق لك استخدام لغة البرمجة والتطبيق عملياً بها؟</h5>
                <label>نعم</label>
               ...
               <div class="form-group">
               <h5>هل تواجهى صعوبة في تعلم البرمجة باللغة الإنجليزية؟</h5>
                <label>نعم</label>
               ...
               <div class="form-group">
               <h5>شرح البرمجة باللغة العربية دافع لك لتعلم البرمجة بشكل أفضل؟</h5>
                <label>نعم</label>
               ...
               <div class="form-group">
               <h5>درست لغة HTML مسبقا؟</h5>
                <label>نعم</label>
                  <input type="radio" name="ques7" value="1" required>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <label>لا</label>
                  <input type="radio" name="ques7" value="5" required>
              </div>
              <div class="form-group">
               <h5>درست لغةالديك فكرة بلغة البرمجة PHP ؟</h5>
                <label>نعم</label>
                  <input type="radio" name="ques8" value="1" required>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <label>لا</label>
                  <input type="radio" name="ques8" value="5" required>
              </div>
              <div class="form-group">
               <h5>هل لديك الرغبة فى تصميم موقع بلغة البرمجة؟</h5>
                <label>نعم</label>
                  <input type="radio" name="ques9" value="1" required>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <label>لا</label>
                  <input type="radio" name="ques9" value="1" required>
              </div>
              <div class="text-center"><button class="get-started-btn" type="submit" name="next">تابع</button></div>
            </form>
          </div>
